...
<flux:callout
    variant="{{ ['approved' => 'success', 'rejected' => 'danger'][$status] ?? 'secondary' }}"
    icon="{{ ['approved' => 'check-circle', 'rejected' => 'x-circle'][$status] ?? 'clock' }}"
    color="{{ ['approved' => 'green', 'rejected' => 'red'][$status] ?? 'zinc' }}"
>
